...
<div id="wrap">
	...
	<input Type="hidden" id="ttNo" name="ttNo" value="T8200003">
		<table border="1">
			...
			<tr>
				<td colspan="2">가정통신문 게시판 글입력하기</td>
			</tr>
			<tr>
				<td>글제목</td>
				<td><input type="text" id="flTitle" name="flTitle" class="A">
			...
			<tr>
				<td>글내용</td>
				<td><textarea name="flContents" id="flContents" rows="10" cols="100" ></textarea></td>
			</tr>
			<tr>
				<td>첨부파일1</td>
